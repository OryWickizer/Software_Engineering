    ...
    <div className="relative flex items-center justify-center min-h-screen bg-emerald-50 overflow-hidden">
      ...
      <div className="relative bg-white/90 backdrop-blur-sm shadow-xl rounded-2xl p-8 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-6">
          <span className="inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700">                                                                                                                      EcoBites • Join Us
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" aria-label={isRegister ? "Registration Form" : "Login Form"}>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>{isRegister ? 'Switch to Sign In' : 'New to EcoBites? Join now'}</span>
            </label>
            <button type="submit" className="px-4 py-2 bg-emerald-600 text-white rounded-lg">{isRegister ? 'Create Account' : 'Sign In'}</button>
          </div>
        </form>
